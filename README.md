...
## Installing R
* Choose a [download mirror site](https://cran.r-project.org/mirrors.html) (Cntrl + click to open in new window) from the list that is close to you geographically  
